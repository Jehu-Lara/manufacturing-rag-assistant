...
- **MRR**: 0.621
- **Recall@5 by language**: English (n=23) 0.913; Spanish (n=7) 0.571 — the multilingual embedding model works cross-lingually, but noticeably less reliably on Spanish queries than English ones against this English-only corpus. Worth watching as the Spanish eval subset grows in a later phase; not a blocker at n=7.

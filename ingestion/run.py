...
from ingestion.loader import Document, load_corpus
...
def build_chunks_for_document(document: Document) -> list[ChunkMetadata]:
    chunks: list[ChunkMetadata] = []
    for index, raw in enumerate(chunk_document(document.body), start=1):
        chunk = ChunkMetadata(

<!-- provenance
source: retrieval_details_v1.1.0__contextual-v1__off.jsonl (per-question top-5 dump, deterministic classifier)
classifier: src/features/evaluation/failure_classification.py::classify_failure
generated: contextual-v1 / expansion_mode=off — deterministic classifier over retrieval_details_v1.1.0__contextual-v1__off.jsonl
...
# Failure classification — eval_set v1.1.0, contextual-v1 index, expansion_mode=off
...
| class | count |
|---|---|
| gate-over-refusal (retrieval OK, gate refuses) | 8 |
| same-document-decoy | 6 |
| cross-document-decoy | 3 |
| retrieval-miss (expected document absent from top-5) | **0** |

**Non-gate retrieval failures = 9 (6 same-document + 3 cross-document). 0 true retrieval misses.**
...
|---|---|---|---|
| q041 | es | `doe-hdbk-1018-1-pumps::chunk-0007` | `doe-hdbk-1018-1-pumps::chunk-0007` |
...
| q071 | es | `niosh-pocket-guide-excerpt::chunk-0002` | `niosh-pocket-guide-excerpt::chunk-0007` |

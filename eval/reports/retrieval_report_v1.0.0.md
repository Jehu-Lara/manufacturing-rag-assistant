...
- Git commit: `af1667b4273f70a12cd3a673ed77fe40e2258abc`
...
## Unanswerable Subset (n=10) — Top-1 Score Distribution

- Fused score: min=0.0278, max=0.0328, mean=0.0318
- Semantic score (pure cosine similarity, `semantic_rank == 1`): min=0.4799, max=0.6548, mean=0.5646
- No refusal/gating decision is made here — Phase 3 picks a threshold from raw semantic_score (see `eval/reports/threshold_analysis_v1.0.0.md`), since fused_score is rank-based and disqualified as a refusal-confidence signal — see SPEC.md's Phase 2 status.

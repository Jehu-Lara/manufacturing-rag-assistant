...
- Review-floor sweep (PR #6): complete — 125-run grid sweep across 24 candidate rules (floors 0.50–0.55 × lexical/semantic agreement signals) proved that 0 candidate rules cleared all global gates G1–G4 without unanswerable promotions or bilingual regressions. This established the pre-registered floor of `0.5500` as the optimal invariant ("diagnóstico sin cambio" / zero production code changes). Report: [`docs/eval/floor_sweep_summary.md`](docs/eval/floor_sweep_summary.md).
